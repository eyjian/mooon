...
static void foo()
{
    for (int i=0,j=0; i<mooon::argument::lines->value(); ++i)
    {
        ...
        /* 1 */ MYLOG_DEBUG("[%u,%d]MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM\n", counter, j);

        ++j;
        counter = static_cast<unsigned int>(atomic_inc_return(&sg_counter));
        /* 2 */ MYLOG_DETAIL("[%u,%d]KKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK\n", counter, j);

        ++j;
        counter = static_cast<unsigned int>(atomic_inc_return(&sg_counter));
        /* 3 */ MYLOG_INFO("[%u,%d]BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB\n", counter, j);

        ++j;
        counter = static_cast<unsigned int>(atomic_inc_return(&sg_counter));
        /* 4 */ MYLOG_ERROR("[%u,%d]TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT\n", counter, j);

        ++j;
        counter = static_cast<unsigned int>(atomic_inc_return(&sg_counter));
        /* 5 */ MYLOG_WARN("[%u,%d]PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP\n", counter, j);

        ++j;
        counter = static_cast<unsigned int>(atomic_inc_return(&sg_counter));
        /* 6 */ MYLOG_TRACE("[%u,%d]AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n", counter, j);

        ++j;
        counter = static_cast<unsigned int>(atomic_inc_return(&sg_counter));
        /* 7 */ MYLOG_STATE("[%u,%d]ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ\n", counter, j);
